...
import NavLink from "@/components/SearchForm";
      ...
      >
        ...
        <div className="flex lg:hidden">
          <button
            ...
            p-2.5 rounded-md text-white hover:text-white hover:bg-[#013B94] 
              ...
              >
                <div className="p4 ">
                  {products.map((item) => (
                    ...
                    >
                      <div
                        className="flex items-center justify-center flex-none w-10 h-10
                       bg-[#013B94] rounded-lg group-hover:bg-gray-200"
                      >
                        <item.icon
                          className="h-6 w-6 text-white group-hover:text-blue-600"
                          aria-hidden="true"
                        />
                      </div>
                      <div>
                        <a
                          href={item.href}
                          className="block text-[#013B94]  font-semibold"
                        >
                          {item.name}
                        </a>
                  ...
                  {callsToAction.map((item) => (
                    <a
                      ...
                      className="flex items-center justify-center gap-x-2.5 p-3 
                            text-sm font-semibold leading-6 text-[#013B94] hover:bg-gray-100"
                    >
                      <item.icon
              ...
              <div className="space-y-2 py-6">
                <Disclosure as="div" className="-mx-3">
                  {({ open }) => (
                    <>
                      ...
                      pr-3.5 text-base font-semibold leading-7 
                ...
                <div>
                  <a
                    href="#"
                    className="flex w-full
                      items-center justify-between rounded-lg py-2 
                      pr-3.5 text-base font-semibold leading-7 
                      text-white hover:bg-blue-800"
                  >
                    Fligths
